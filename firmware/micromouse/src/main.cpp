...
//         analogWrite(leftMotorBackward,
//                     !direction * fixSpeed(speedl - speeda)); // also might add a constrain fa lw el speed less/greater
//                                                              // than the limits, it doesn't overflow
//
...
//         return 0;
//     if (speed > 0)
//         return map(speed, 0, 150, 45, 150);
//     if (speed < 0)
//         return map(speed, -150, 0, -150, -45);
//     return -1; //to silent compiler warnings
// }
//
...
// {
//     double leftRevolutions = 1.0 * leftEncoder.getCount() / ticksperlafa;
//     double rightRevolutions = 1.0 * rightEncoder.getCount() / ticksperlafa;
//
